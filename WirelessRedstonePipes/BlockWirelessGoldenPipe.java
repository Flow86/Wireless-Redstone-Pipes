...
public class BlockWirelessGoldenPipe extends BlockGoldenPipe {
	...
	/* (non-Javadoc)
	 * @see net.minecraft.src.buildcraft.transport.BlockGoldenPipe#getBlockEntity()
	 */
	@Override
	...
	/* (non-Javadoc)
	 * @see net.minecraft.src.buildcraft.transport.BlockGoldenPipe#getBlockTexture(net.minecraft.src.IBlockAccess, int, int, int, int)
	 */
	@Override
	public int getBlockTexture(IBlockAccess iblockaccess, int i, int j, int k,
		...
		IWirelessPipe tile = (IWirelessPipe) APIProxy.getWorld()
